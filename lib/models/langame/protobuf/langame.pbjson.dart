...
final $typed_data.Uint8List memeDescriptor = $convert.base64Decode('');
...
const UserPreference_Notification$json = const {
  ...
  '2': const [
    ...
    const {'1': 'new_version', '3': 3, '4': 1, '5': 11, '6': '.langame.protobuf.UserPreference.Notification.NewVersion', '10': 'newVersion'},
  ],
  '3': const [UserPreference_Notification_Invite$json, UserPreference_Notification_Message$json, UserPreference_Notification_NewVersion$json],
};
...
@$core.Deprecated('Use userPreferenceDescriptor instead')
const UserPreference_Notification_NewVersion$json = const {
  '1': 'NewVersion',
  '2': const [
    const {'1': 'email', '3': 1, '4': 1, '5': 8, '10': 'email'},
    const {'1': 'push', '3': 2, '4': 1, '5': 8, '10': 'push'},
...
final $typed_data.Uint8List userPreferenceDescriptor = $convert.base64Decode('');
